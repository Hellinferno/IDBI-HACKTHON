...
| category_id | uuid fkâ†’categories | nullable until classified |
| txn_date | date | |
...
|---|---|---|
| id | uuid pk | |
| name | text | groceries, rent, sipâ€¦ |
| parent_id | uuid fkâ†’categories | nullable |
...
| disclaimer_id | uuid fkâ†’disclaimers | |
...
## Key relations
- user 1â€”N accounts 1â€”N transactions Nâ€”1 categories
- user 1â€”1 financial_profile, 1â€”N risk_assessments (current = latest valid)
- user 1â€”N goals 1â€”N goal_projections
- user 1â€”N portfolios 1â€”N holdings
- user 1â€”N recommendations Nâ€”1 disclaimers, â†’ audit_logs

## Retention
- transactions, profiles: while consent active + regulatory minimum.
- audit_logs: â‰¥ 7 years, append-only, never deleted.
