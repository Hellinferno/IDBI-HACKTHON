...
flowchart TB
    ...
    Gateway["API Gateway<br/>auth · rate-limit · audit hook"]
    ...
    subgraph Services["Backend Services"]
        ...
        Compliance["Compliance Service<br/>suitability · audit"]
    end
...
sequenceDiagram
    ...
    C->>C: TTS plays → amplitude drives Orb pulse
